"""
Glue 5.0 Job: Payments Processing
Processes payments from staging to reporting with incremental MERGE
"""
...
sql_query = f"""
    SELECT 
        ...
        p.card_type, 
        p.details
    FROM {CATALOG}.{STAGE_DB}.payments p 
    JOIN {CATALOG}.{STAGE_DB}.merchants m ON m.id = p.merchant_id 
    WHERE p.created_at >= TIMESTAMP '2025-09-01 00:00:00'
"""
