"""
Glue 5.0 Job: Link Transactions Processing
Processes link transactions from staging to reporting with incremental MERGE
"""
...
sql_query = f"""
    SELECT id, created_at, updated_at, state, linkpay_reference, payment_details 
    FROM {CATALOG}.{STAGE_DB}.link_transactions
